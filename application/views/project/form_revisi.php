<div class="col-md-10">
	<h3>REVISI PROJECT</h3>
	<div class="panel panel-primary">
		<div class="panel-heading">
			Form Revisi Project
		</div>
		<div class="panel-body">
			<form action="<?php echo base_url('project/send_revisi'); ?>" method="post" class="form-group">
				<div class="row">
					<div class="col-md-10">
				...
				<textarea name="keterangan" rows="3" class="form-control" placeholder="Keterangan revisi project" required></textarea>
				...
				<a href="<?php echo base_url('dashboard/master') ?>" class="btn btn-default">Kembali</a>
			</form>
		</div>
	</div>
</div>
