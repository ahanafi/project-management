<div class="col-md-10">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form action="<?php echo base_url('project/upload/'.$p->id); ?>" method="post" class="form-group" enctype="multipart/form-data">
				<div class="row">
					<div class="col-md-10">
				...
				<a href="<?php echo base_url('dashboard/design'); ?>" class="btn btn-default">Kembali</a>
			</form>
		</div>
	</div>
</div>
