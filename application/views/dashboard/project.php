				...
				<table class="table table-bordered table-responsive table-hover" id="data">
					...
					<?php foreach($projects as $pro): ?>
						<tr class="data_rows">
							...
							<td class="ctr">
								<a href="<?php echo base_url('project/edit/'.$pro->id); ?>" class="btn btn-default"><i class="fa fa-pencil"></i></a>
								<a onclick="return konfirmasi('menghapus data ini')" href="<?php echo base_url('project/delete/'.$pro->id); ?>" class="btn btn-default"><i class="fa fa-trash"></i></a>
							</td>
						</tr>
					<?php endforeach; ?>					
					<?php endif; ?>
