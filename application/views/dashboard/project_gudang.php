	...
	<div class="panel panel-primary">
		...
		<div class="panel-body" id="main-content">
			<div id="data-content">
				<table class="table table-bordered table-responsive table-hover" id="data">
					...
					<?php foreach($projects as $pro): ?>
						<tr class="data_rows">
							...
							<td class="ctr">
								<?php if($pro->id_rack != NULL): ?>
									<span class="fa fa-check" style="margin-top: 10%;font-size: 2em;" data-toggle="tooltip" data-placement="top" title="Posisi project telah disetting"></span>
								<?php else : ?>
									<a href="<?php echo base_url('project/position/'.$pro->id); ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Tentukan posisi project!"><i class="fa fa-arrows"></i></a>
								<?php endif; ?>
							</td>
						</tr>
					<?php endforeach; ?>					
				...
				<div class="row">
					<div class="col-md-6">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addProject">New Project</button>
						<a href="<?php echo base_url('export/export_excel/project'); ?>" class="btn btn-success">Export Ms. Excel</a>
						<a target="_blank" href="<?php echo base_url('export/export_pdf/project'); ?>" class="btn btn-default">Cetak PDF</a>
					</div>
				</div>
			</div>
		</div>
