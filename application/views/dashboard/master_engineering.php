							...
							<?php foreach($projects as $pro): ?>
								<tr class="data_rows">
									...
									<?php if($pro->revisi == 1): ?>
										...
										<td class="ctr">
											<a href="#" class="btn btn-default" disabled="disabled" data-toggle="tooltip" data-placement="top" title="Tidak dapat mengirim project!" onclick="alert('Project yang direvisi tidak bisa dikirim!');">
									...
									<?php else : ?>
										<?php if($pro->terkirim == 0): ?>
											<td class="ctr">
												<a href="#" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Revisi project" disabled="disabled">
													<i class="fa fa-retweet"></i>
												</a>
											</td>
											<td class="ctr">
												<a href="#" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Kirim project" disabled="disabled">
													<i class="fa fa-send"></i>
												</a>
											</td>
										<?php elseif($pro->terkirim == 1): ?>
											<td class="ctr">
												<a href="#" class="btn btn-default" disabled="disabled" data-toggle="tooltip" data-placement="top" title="Tidak dapat merevisi project!" onclick="alert('Project tidak bisa direvisi!')">
													<i class="fa fa-retweet"></i>
												</a>
											</td>
											<td class="ctr">
												<a href="<?php echo base_url('project/send_end/'.$pro->id); ?>" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Kirim project ke Gudang"><i class="fa fa-send"></i></a>
											</td>
										<?php else : ?>
											<td class="ctr">
												<a href="#" class="btn btn-default" disabled="disabled" data-toggle="tooltip" data-placement="top" title="Tidak dapat merevisi project!" onclick="alert('Project tidak bisa direvisi!')">
											...
											<td class="ctr">
												<span style="font-size: 2em;margin-top: 10%;" class="fa fa-check" data-toggle="tooltip" data-placement="top" title="Project telah terkirim ke Gudang"></span>
											</td>
										<?php endif; ?>
									<?php endif; ?>
								</tr>
